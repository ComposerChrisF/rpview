...
fn test_cli_workflow_single_file() {
    ...
    assert_eq!(state.current_image().unwrap().file_name().unwrap(), "image2.jpg");
}
...
fn test_file_loading_workflow_drag_and_drop() {
    ...
    assert_eq!(state.current_image().unwrap().file_name().unwrap(), "dropped.png");
...
fn test_navigation_workflow_preload_paths() {
    ...
    assert_eq!(state.next_image_path().unwrap().file_name().unwrap(), "image2.jpg");
    
    // At first image, previous should be image3 (wraparound)
    assert_eq!(state.previous_image_path().unwrap().file_name().unwrap(), "image3.gif");
}
...
fn test_zoom_workflow_fit_to_window_then_manual() {
    ...
    let mut zoom = calculate_fit_to_window(
        image_width,
        image_height,
        viewport_width,
        viewport_height
    ...
    assert!(zoom > calculate_fit_to_window(
        image_width,
        image_height,
        viewport_width,
        viewport_height
...
fn test_zoom_workflow_toggle_fit_100() {
    ...
    let fit_zoom = calculate_fit_to_window(
        image_width,
        image_height,
        viewport_width,
        viewport_height
